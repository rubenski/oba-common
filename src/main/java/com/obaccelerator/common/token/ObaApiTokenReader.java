...
public class ObaApiTokenReader {
    ...
    private static final String TOKEN_INVALID_MESSAGE_CLAIMS = "API token invalid: wrong number of claims. API tokens are generated by OBA and should always be valid.";
    private static final String TOKEN_INVALID_MESSAGE_UUID = "API token invalid: cannot parse client UUID. API tokens are generated by OBA and should always be valid.";
    private static final String TOKEN_INVALID_SIGNATURE = "API token invalid: signature is invalid. API tokens are generated by OBA and should always be valid.";
    ...
    public void validateToken(final String token, final PublicKey publicKey) throws ApiTokenException {
        ...
        boolean b = verifySignature(token, publicKey);
    ...
    private boolean verifySignature(final String token, final PublicKey publicKey) throws ApiTokenException {
