...
public class ApiTokenValidator {
    ...
    public void validateClientToken(final String token, final PublicKey publicKey) throws ApiTokenValidationException {

        verifySignature(token, publicKey);

        Map<String, Object> claims = null;
        try {
            claims = apiTokenReader.readClaims(token, publicKey);
    ...
    public void validateElevatedToken(final String token, final String elevatedRoleName, final PublicKey publicKey) throws ApiTokenValidationException {
    ...
    private void verifySignature(String token, PublicKey publicKey) throws ApiTokenValidationException {
        try {
            apiTokenReader.verifySignature(token, publicKey);
